defmodule TeacherAssistant.Repo.Migrations.MigrateResourcesExtensions1 do
  @moduledoc """
  ...
  def down do
    # Left as a no-op: these functions/extension are depended on by every
    # table's `id` column default across the schema, so an unconditional
    # DROP FUNCTION here is unsafe to run automatically.
    :ok
  end
end
